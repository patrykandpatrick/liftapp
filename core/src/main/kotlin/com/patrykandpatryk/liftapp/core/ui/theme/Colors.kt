...
object Colors {
    ...
    object Light {
        ...
        val error = Color(color = 0xfffabd00)
        val errorContainer = Color(color = 0xffffecb3)
    ...
    object Dark {
        ...
        val error = Color(color = 0xffffD54f)
        val errorContainer = Color(color = 0xFF6B4F00)
        val onError = Color(color = 0xff601410)
        val onErrorContainer = Color(color = 0xffF9dedc)
