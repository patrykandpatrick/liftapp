...
data class ExerciseSetEntity(
    @PrimaryKey(autoGenerate = true) @ColumnInfo(name = "exercise_set_id") val id: Long = 0L,
    @ColumnInfo(name = "exercise_set_workout_id", index = true) val workoutID: Long,
    @ColumnInfo(name = "exercise_set_exercise_id", index = true) val exerciseID: Long,
    @ColumnInfo(name = "exercise_set_weight") val weight: Double? = null,
    @ColumnInfo(name = "exercise_set_weight_unit") val weightUnit: MassUnit? = null,
    @ColumnInfo(name = "exercise_set_reps") val reps: Int? = null,
    @ColumnInfo(name = "exercise_set_time") val timeMillis: Long? = null,
