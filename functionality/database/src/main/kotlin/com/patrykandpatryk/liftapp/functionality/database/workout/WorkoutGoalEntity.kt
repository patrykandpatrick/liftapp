...
data class WorkoutGoalEntity(
    ...
    @ColumnInfo(name = "workout_goal_id")
    val id: Long,
    @ColumnInfo(name = "workout_goal_workout_id", index = true)
    val workoutID: Long,
    @ColumnInfo(name = "workout_goal_exercise_id", index = true)
    val exerciseID: Long,
    @ColumnInfo(name = "workout_goal_min_reps")
    val minReps: Int,
    @ColumnInfo(name = "workout_goal_max_reps")
    val maxReps: Int,
    @ColumnInfo(name = "workout_goal_sets")
    val sets: Int,
    @ColumnInfo(name = "workout_goal_break_duration")
