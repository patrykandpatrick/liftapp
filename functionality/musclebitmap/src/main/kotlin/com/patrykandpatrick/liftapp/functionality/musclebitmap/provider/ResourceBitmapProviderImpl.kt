...
import com.patrykandpatrick.liftapp.functionality.musclebitmap.R
import javax.inject.Inject

class ResourceBitmapProviderImpl @Inject constructor(private val resources: Resources) :
    ResourceBitmapProvider {

    override fun getBodyFrontBitmap(): Bitmap = getBitmap(R.drawable.body_front)

    override fun getBodyRearBitmap(): Bitmap = getBitmap(R.drawable.body_back)
