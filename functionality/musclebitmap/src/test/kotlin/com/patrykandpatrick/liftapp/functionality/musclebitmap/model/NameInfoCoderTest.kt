...
import com.patrykandpatrick.liftapp.functionality.musclebitmap.di.MuscleBitmapModule
...
class NameInfoCoderTest {
    ...
    private val sut: NameInfoCoder = NameInfoCoder(Json, MuscleBitmapModule.provideSha1Algorithm())
